Public Class ETF_PriceImport_AssetClassWeighting
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            'Else
            SQLstr = "UPDATE mdb_ETFPrice_ModelAssetClass SET TargetWeight = " & wgt & " WHERE ID = " & ID.Text
            'End If
    ...
    Private Sub ETF_PriceImport_AssetClassWeighting_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        TextBox1.Focus()
    End Sub
End Class