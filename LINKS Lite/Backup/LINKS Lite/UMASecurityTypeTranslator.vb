Public Class UMASecurityTypeTranslator
    ...
    Public Sub LoadCodes()
        Try
            ...
            Dim strSQL As String = "SELECT * FROM uma_envestnet_sectype"
    ...
    Private Sub UMASecurityTypeTranslator_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call LoadCodes()
    End Sub

    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Dim child As New UMASecType
        ...
        Else
            ...
            If ir = MsgBoxResult.Yes Then
                ...
                Try
                    ...
                    SQLstr = "DELETE * FROM uma_envestnet_sectype WHERE ID = " & DataGridView1.SelectedCells(0).Value
