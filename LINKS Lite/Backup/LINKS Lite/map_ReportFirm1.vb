...
Public Class map_ReportFirm1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SMA_Toolbox.map_ReportFirm1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedmap_ReportFirm1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As map_ReportFirm1 = New map_ReportFirm1
        rpt.Site = Me.Site
        Return rpt
    End Function
