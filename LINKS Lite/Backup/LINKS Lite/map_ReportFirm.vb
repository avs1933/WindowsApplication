...
Public Class map_ReportFirm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SMA_Toolbox.map_ReportFirm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedmap_ReportFirm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As map_ReportFirm = New map_ReportFirm
        rpt.Site = Me.Site
        Return rpt
    End Function
