...
Public Class map_Reports_Firm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SMA_Toolbox.map_Reports_Firm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedmap_Reports_Firm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As map_Reports_Firm = New map_Reports_Firm()
        rpt.Site = Me.Site
        Return rpt
    End Function
