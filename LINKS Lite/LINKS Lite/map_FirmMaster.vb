...
Public Class map_FirmMaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SMA_Toolbox.map_FirmMaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedmap_FirmMaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As map_FirmMaster = New map_FirmMaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
