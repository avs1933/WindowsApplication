...
Public Class map_Report_FirmALL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SMA_Toolbox.map_Report_FirmALL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedmap_Report_FirmALL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As map_Report_FirmALL = New map_Report_FirmALL()
        rpt.Site = Me.Site
        Return rpt
    End Function
