...
Public Class ProposalCover
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SMA_Toolbox.ProposalCover.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProposalCover
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ProposalCover = New ProposalCover()
        rpt.Site = Me.Site
        Return rpt
    End Function
